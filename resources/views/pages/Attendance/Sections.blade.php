                                                            ...
                                                            <tbody>
                                                                ...
                                                                @foreach ($Grade->sections as $x)
                                                                    <tr>
                                                                        ...
                                                                        <td>{{ $i }}</td>
                                                                        <td>{{ $x->trans_name }}</td>
                                                                        <td>{{ $x->class_room->trans_name }}
                                                                        </td>
                                                                        <td>
                                                                            <label
                                                                                class="badge badge-{{ $x->Status == 1 ? 'success' : 'danger' }}">{{ $x->Status == 1 ? 'نشط' : 'غير نشط' }}</label>
                                                                        </td>

                                                                        <td>
                                                                            <a href="{{ route('Attendance.show', $x->id) }}"
