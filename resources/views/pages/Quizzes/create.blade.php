...
<div class="page-title">
    <div class="row">
        <div class="col-sm-6">
            <h4 class="mb-0"> {{ __('main_tans.add_new_exams') }}
        ...
        <div class="col-sm-6">
            <ol class="breadcrumb pt-0 pr-0 float-left float-sm-right ">
                ...
                <li class="breadcrumb-item active"> {{ __('main_tans.add_new_exams') }}
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="custom-select mr-sm-2" name="subject_id">
                                            ...
                                            @foreach ($subjects as $subject)
                                                <option value="{{ $subject->id }}">{{ $subject->trans_name }}
                                                </option>
                                            @endforeach
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="custom-select mr-sm-2" name="teacher_id">
                                            ...
                                            @foreach ($teachers as $teacher)
                                                <option value="{{ $teacher->id }}">{{ $teacher->trans_name }}
                                                </option>
                                            @endforeach
                                        </select>
                                    </div>
