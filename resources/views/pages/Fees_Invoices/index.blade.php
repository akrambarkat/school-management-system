...
<div class="page-title">
    <div class="row">
        <div class="col-sm-6">
            <h4 class="mb-0"> {{ __('main_tans.Tuition_bills') }}
        ...
        <div class="col-sm-6">
            <ol class="breadcrumb pt-0 pr-0 float-left float-sm-right ">
                ...
                <li class="breadcrumb-item active"> {{ __('main_tans.Tuition_bills') }}
                </li>
            </ol>
        </div>
    </div>
                            ...
                            <table id="datatable" class="table  table-hover table-sm table-bordered p-0"
                                ...
                                <thead>
                                    <tr class="alert-success">
                                        ...
                                        <th>{{ __('main_tans.Type_of_fee') }}</th>
                                ...
                                <tbody>
                                    @foreach ($Fee_invoices as $Fee_invoice)
                                        <tr>
                                            ...
                                            <td>{{ $Fee_invoice->student->trans_name }}</td>
                                            <td>{{ $Fee_invoice->fees->trans_name }}</td>
                                            <td>{{ number_format($Fee_invoice->amount, 2) }}</td>
                                            <td>{{ $Fee_invoice->grade->trans_name }}</td>
                                            <td>{{ $Fee_invoice->classroom->trans_name }}</td>
                                            ...
                                            <td>
                                                ...
                                                <button type="button" class="btn btn-danger btn-sm" data-toggle="modal"
                                                    data-target="#Delete_Fee{{ $Fee_invoice->id }}"
                                        ...
                                        <div class="modal fade" id="Delete_Fee{{ $Fee_invoice->id }}" tabindex="-1"
