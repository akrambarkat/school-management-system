                ...
                <div class="btn-group mb-1">
                    <button type="button" class="btn btn-light btn-sm dropdown-toggle" data-toggle="dropdown"
                        ...
                        @if (App::getLocale() == 'ar')
                            ...
                            <img src="{{ URL::asset('assets/images/flags/ps.png') }}" alt="">
                        @else
                            {{ LaravelLocalization::getCurrentLocaleName() }}
                        ...
                        <div class="dropdown-header">
                            <div class="media">
                                <div class="media-body">
                                    <h5 class="mt-0 mb-0">{{ Auth::user()->trans_name }}</h5>
                                    <span>{{ Auth::user()->email }}</span>
                                </div>
                            </div>
                        </div>
                        
                        <a class="dropdown-item" href="{{ route('settings.index') }}"><i class="text-info ti-settings"></i>{{ __('main_tans.settings') }}</a>
