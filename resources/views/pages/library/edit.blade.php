...
@section('css')
@section('title')
    {{ __('main_tans.edit_books') }} => {{ $book->title }}
@stop
@endsection
@section('page-header')
<!-- breadcrumb -->
<div class="page-title">
    <div class="row">
        <div class="col-sm-6">
            <h4 class="mb-0"> {{ __('main_tans.edit_books') }} => {{ $book->title }}
        ...
        <div class="col-sm-6">
            <ol class="breadcrumb pt-0 pr-0 float-left float-sm-right ">
                ...
                <li class="breadcrumb-item active"> {{ __('main_tans.edit_books') }}
                    ...
                    <div class="col-md-12">
                        ...
                        <form action="{{ route('Library.update', $book->id) }}" method="post"
                            ...
                            <div class="form-row">
                                ...
                                <div class="col">
                                    <label for="title">{{ __('main_tans.name_books') }} : <span
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="custom-select mr-sm-2" name="Classroom_id">
                                            <option value="{{ $book->classroom_id }}">
                                                {{ $book->classroom->trans_name }}</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <select class="custom-select mr-sm-2" name="section_id">
                                            <option value="{{ $book->section_id }}">{{ $book->section->trans_name }}
                                            </option>
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="form-row">
                                <div class="col">
                                    ...
                                    <embed src="{{ URL::asset('Attachment/library/' . $book->file_name) }}"
                                        type="application/pdf" height="150px" width="100px"><br><br>

                                    <div class="form-group">
                                        <label for="academic_year">{{ __('main_tans.Attachments') }} : <span
